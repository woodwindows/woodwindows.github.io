...
<text font-size="4" x="-8" y="${this.materialSashThickness/2}" class="location">EXT</text>
    ...
    */
    ...
    get parts() {
        ...
        return [
            ...
            { count: casementCount * 4, name: "Peg or dowel", dimensions: ['?', '?', this.materialSashThickness - 6] },
